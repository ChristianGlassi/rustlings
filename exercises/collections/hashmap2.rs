...
fn fruit_basket(basket: &mut HashMap<Fruit, u32>) {
    ...
    for fruit in fruit_kinds {
        ...
        // present!
        match fruit {
            Fruit::Pineapple => basket.entry(Fruit::Pineapple).or_insert(5),
            Fruit::Banana => basket.entry(Fruit::Banana).or_insert(5),
            Fruit::Apple => basket.entry(Fruit::Apple).or_insert(5),
            Fruit::Lichi => basket.entry(Fruit::Lichi).or_insert(5),
